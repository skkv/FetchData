...
System Date fetched from App Server using java Gregorian Calendar: <%= DateProvider.returnGregorianCalendarTimestamp() %> <p>
System Date from DB Server: <%= DateProvider.returnDBDate()%>
